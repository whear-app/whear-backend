...
public static class TotpHelper
{
    ...
    private static int ComputeTotp(HashAlgorithm hashAlgorithm, ulong timestepNumber, string? modifier = null)
    {
    ...
    private static byte[] ApplyModifier(byte[] input, string? modifier = null)
    {
